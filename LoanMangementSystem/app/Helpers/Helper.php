...
class Helper
{
    ...
    public static function LoanNumberGenerator($model, $trow, $length = 4, $prefix){
        $data = $model::orderBy('lid','desc')->first();
        if(!$data){
            $og_length = $length;
            $last_number = '';
        }else{
    ...
    public static function AccountNumberGenerator($model, $trow, $length = 4, $prefix){
        $data = $model::orderBy('bno','desc')->first();
        if(!$data){
            $og_length = $length;
            $last_number = '';
        }else{
