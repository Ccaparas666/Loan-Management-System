                        ...
                        <table id="example" class="display nowrap text-sm text-left text-black-500 dark:text-gray-400" style="width:100%">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3">
                                        <div class="flex items-center">{{ __('Approved by') }}<a href="#"></div>
                                    </th>
                                    <th scope="col" class="px-6 py-3">
                                        <div class="flex items-center">{{ __('Approved Date') }}<a href="#"></div>
                                    </th>
                                    <th scope="col" class="px-6 py-3">
