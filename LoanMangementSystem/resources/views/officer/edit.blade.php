...
<div class="p-4 sm:ml-64" id="hide">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('officer-update',['ofno' => $OffInfo->ono]) }}" >
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-4">
                            ...
                            <div class="mb-4">
                                <label for="xpassword_confirmation" class="block mb-2 text-sm font-bold text-blue-700 dark:text-blue-300">CONFIRM
                                    PASSWORD</label>
    ...
    <select id="default" name="Role" required
        ...
        <option selected hidden value="{{ $OffInfo->is_admin }}">{{ $OffInfo->is_admin == 1 ? 'Loan Manager' : 'Loan Officer' }}</option>
