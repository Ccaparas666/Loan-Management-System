...
<body>
    ...
    @if ($sendCoMaker['emailType'] === 'LoanApply')
        ...
        <table border="1">
    <tr>
        <td colspan="2" style="background-color: #0d71b4fd; color: #fff;"><strong>Application Details:</strong></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <p style="margin-top: 20px;">
            Thank you for being a co-maker with LendWise.
        </p>
    ...
    <tr>
        <td><strong>Loan Status:</strong></td>
        <td class="{{ $sendCoMaker['loanStatus'] === 'Loan Active' ? 'loan-active-status' : ($sendCoMaker['loanStatus'] === 'PAID' ? 'paid-status' : '') }}">
